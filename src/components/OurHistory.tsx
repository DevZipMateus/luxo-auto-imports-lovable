...
const OurHistory = () => {
  return (
    <section className="py-16 bg-gradient-to-b from-white to-tradelight">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-tradedark mb-12 relative 
