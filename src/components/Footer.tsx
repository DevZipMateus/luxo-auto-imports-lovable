        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-gray-400 hover:text-tradeblue transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start space-x-3">
                <Phone size={18} className="text-tradeblue mt-1" />
                <div>
                  <p className="text-gray-300">+55 (11) 4198-6237</p>
                  <p className="text-gray-300">+55 (11) 98303-4915 (WhatsApp)</p>
                </div>
              </li>
              <li className="flex items-start space-x-3">
                <MapPin size={18} className="text-tradeblue mt-1" />
                <p className="text-gray-300">São Paulo, SP - Brasil</p>
              </li>
              <li className="flex items-start space-x-3">
                <Mail size={18} className="text-tradeblue mt-1" />
